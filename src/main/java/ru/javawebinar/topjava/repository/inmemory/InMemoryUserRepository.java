...
public class InMemoryUserRepository implements UserRepository {
    ...
    {
        this.save(new User(counter.incrementAndGet(), "Admin", "admin@host.com","1234", Role.ADMIN));
        this.save(new User(counter.incrementAndGet(), "User", "user@host.com","1234", Role.USER));
    }
